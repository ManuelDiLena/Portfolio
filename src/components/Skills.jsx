        ...
        <section id='skills'>
            <div className='container px-5 sm:py-20 py-16 mx-auto'>
                <div className='text-center mb-4'>
                    <FiSettings className='w-10 inline-block mb-4 text-orange sm:text-4xl text-3xl'/>
                ...
                <div className='flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2'>
                    {skills.map((skill) => (
                        <div key={skill} className='p-1 sm:w-1/2 w-full'>
                            <div className='bg-gray rounded flex p-2 h-full items-center'>
                                <AiOutlineCheckCircle className='text-orange w-6 h-6 flex-shrink-0 mr-4'/>
